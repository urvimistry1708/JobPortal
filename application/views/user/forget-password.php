...
<body class="body__inner">
 ...
 <?php $this->load->view('user/templates/useraccount-header')?>
	...
	<div class="flash-messages">
			...
			<div class="page-row page-row-expanded" style="background-image: url('<?php echo base_url(); ?>user_assets/img/imgreg.png'); background-size:cover;">
	...
	<div class="form-group">
		...
		<input type="email" name="email_id" id="email_id" value="" class="form-control" placeholder="Email"/>
		<span id="err_customer_email_id"></span>
	</div>
	<div class="form-group form-group__btns text-center">
		<input type="button" onclick="forgotpassword()" name="sendemail" value="Send Me Email" class="btn btn__orange btn__bold" />
	</div>
</form>
