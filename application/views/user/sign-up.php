...
<body class="body__inner">
 ...
 background-image: url('<?php echo base_url(); ?>user_assets/img/imgreg.png');background-size: cover;">
    ...
    <div class="registration-choose__groups">
                   <a class="btn btn__orange jobseeker-group" href="jobseeker"><img src="<?php echo base_url(); ?>user_assets/img/avatar.png" height="40" width="40"><br><br>Job Seeker</a>
                    <a class="btn btn__orange employer-group" href="employer"><img src="<?php echo base_url(); ?>user_assets/img/building.png" height="40" width="40"><br><br>Employer</a>
            </div>
