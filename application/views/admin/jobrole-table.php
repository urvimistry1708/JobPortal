                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>Job Role </div>
                                        <div class="tools"> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                               ...
                                               ?>
                                               <tr>
                                                   <td><?php echo $row['job_role_title']; ?></td>
                                                   
                                                   <td><a href="<?php echo base_url();?>admin/jobroletable/getJobrole?id=<?php echo $row['job_role_id']?>"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp&nbsp<a><i class="fas fa-minus-circle" onclick="deletedata(<?php echo $row['job_role_id']; ?>)" ></i></a></td>
                                               </tr>
                                               <?php
                                           }
                                           ?>
