                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td><a href="<?php echo base_url();?>admin/countrytable/getCountry?id=<?php echo $row['country_id']?>"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp&nbsp<a><i class="fas fa-minus-circle" onclick="deletedata(<?php echo $row['country_id']; ?>)" ></i></a></td>
                                               </tr>
                                               <?php
                                           }
                                           ?>
