                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>Skill </div>
                                        <div class="tools"> </div>
                                    </div>
                                            ...
                                            <tbody>
                                               ...
                                               <?php  
                                                 ...
                                                 {  
                                                    ...
                                                    <td><a href="<?php echo base_url();?>admin/skillsettable/getskill?id=<?php echo $row['skill_id']?>"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp&nbsp<a><i class="fas fa-minus-circle" onclick="deletedata(<?php echo $row['skill_id']; ?>)" ></i></a></td>
                                                      </tr>  
                                                 <?php }  
                                                 ?>  
