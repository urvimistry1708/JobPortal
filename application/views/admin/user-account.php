...
<head>
        ...
        <?php  $this->load->view('admin/templates/useraccount-header-user');?>
    </head>
    <!-- END HEAD -->
                        ...
                        <!-- END PAGE BAR -->
                                            ...
                                            <div class="portlet light bg-inverse">
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                   <!--  <form  id="user_account" name="user_account" enctype="multipart/form-data" class="horizontal-form"> -->
                                                                    <div class="portlet light bg-inverse">
                                                <div class="portlet-title">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Enter user name"><span id="erruname" class="text-danger"></span>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        <input type="email" id="email_id" name="email_id" class="form-control" placeholder="Enter email id">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" placeholder="dd/mm/yyyy"> </div>
                                                                </div>
                                                                <!--/span-->
                                                            </div>
                                                            <!--/row-->
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        type="checkbox" name="smsnotification" id="smsnotification" value="1"></label>&nbsp;&nbsp;&nbsp;
                                                                        &nbsp;&nbsp;&nbsp;
                                                                        <label class="control-label">Email Notification Active &nbsp;&nbsp;&nbsp;<input
                                                                        type="checkbox" name="emailnotification" id="emailnotification" value="1"></label>
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
                                                              <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" id="registration_date" name="registration_date" class="form-control" placeholder="dd/mm/yyyy"> </div>
                                                                </div>
                                                            </div>
                             ...
                             <div class="col-md-6">
                                                        ...
                                                        <div class="form-actions left">
                                                            <input type="submit" class="btn blue" class="fa fa-check">
