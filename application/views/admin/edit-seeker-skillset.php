                ...
                <!-- BEGIN CONTENT -->
                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form id="seeker-skill-set"  class="horizontal-form">
                                                        <?php
                                                            foreach($seeker_skill_list as $list)
                                                            {
                                                        ?>
                                                        <div class="form-body">
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">jobseeker skill set Details</span>
                                    ...
                                    <div class="col-md-6">
                                                    <div class="form-group">
                                                     ...
                                                     <input type="text" name="seeker_skillset_id" id="seeker_skillset_id" value="<?php echo $list['seeker_skillset_id']; ?>" hidden>
                                        ...
                                        ?>
                                        <option value="<?php echo $ulist['user_id']; ?>" <?php 
                                           if($ulist['user_id']==$list['user_id'])
                                           {
                                              echo "selected";
                                           }
                                         ?>><?php echo $ulist['user_name']; ?></option>
                                    <?php } ?>
                                         
                                                                      </select>
                                                     <span id="erruname" class="text-danger">  </span>
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
                                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                     <label class="control-label">Skill <span style="color: red;">*</span></label>
                                        ...
                                        <option value="<?php echo $list['skill_id']; ?>"><?php echo $list['skill_name']; ?></option>
                                         ...
                                         <?php 
                                        foreach($skillsetList as $slist){ 
                                        ?>
                                        <option value="<?php echo $slist['skill_id']; ?>" <?php 
                                           if($slist['skill_id']==$list['skill_id'])
                                           {
                                              echo "selected";
                                           }
                                         ?>><?php echo $slist['skill_name']; ?></option>
                                    <?php } ?>
