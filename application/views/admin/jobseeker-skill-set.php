                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form action="" id="seeker-skill-set" class="horizontal-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php foreach($this->jobseeker_skillset_model->users() as $tagData):?>
                                        <option value="<?php echo $tagData->user_id; ?>"><?php echo $tagData->user_name; ?></option>
                                    <?php endforeach;?>
                                    <!--  <option value="Administrative">Administrative</option>
                                     ...
                                     <option value="Insurance">Insurance</option> -->
                                        ...
                                        <?php foreach($this->jobseeker_skillset_model->skillset() as $tagData):?>
                                        <option value="<?php echo $tagData->skill_id; ?>"><?php echo $tagData->skill_name; ?></option>
                                    <?php endforeach;?>
                                    <!--  <option value="Administrative">Administrative</option>
                                     <option value="Corporate">Corporate</option>
                                     <option value="Insurance">Insurance</option> -->
