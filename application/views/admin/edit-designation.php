                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form action="#" id="services" class="horizontal-form">
                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    <form method="POST" class="horizontal-form">
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">Designation</span>
                                                ...
                                                <input type="text" name="designation_id" id="designation_id" value="<?php echo $list['designation_id']; ?>" hidden>
                                                <input type="text" id="designationn" name="designationn" class="form-control" placeholder="Enter designation" value="<?php echo $list['designation'] ;?>">
                                                <span id="errs" class="text-danger">  </span>
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
...
<![endif]-->
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery-3.3.1.min.js?<?php echo rand(0,9999);?>"></script>
         <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/designation.js?<?php echo rand(0,9999);?>?<?php echo rand(0,9999);?>"></script>
