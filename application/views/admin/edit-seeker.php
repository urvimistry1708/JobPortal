                                            ...
                                            <div class="portlet light bg-inverse">
                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" id="firstname" name="firstname" class="form-control" placeholder="Enter First Name" value="<?php echo $list['firstname'] ;?>">
                                                        ...
                                                        <input type="text" id="middlename" name="middlename" class="form-control" placeholder="Enter Middle Name" value="<?php echo $list['middlename']; ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" id="lastname" name="lastname" class="form-control" placeholder="Enter Last Name" value="<?php echo $list['lastname']; ?>">
                                                        ...
                                                        <input type="text" id="email" name="email" class="form-control" placeholder="abc@gmail.com" value="<?php echo $list['email']; ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" id="mobile" class="form-control" value="<?php echo $list['mobileno']; ?>">
                                                        ...
                                                        <input type="text" id="address" name="address" class="form-control" value="<?php echo $list['address']; ?>">
                                                       ...
                                                       <!--  if($list['exo_fre']=='Experience') -->
                                                     <input type="radio" id="experience" name="seeker" value="Experience"  <?php if ($list['exp_fre'] == 'Experience' ) echo 'checked' ; ?>>Experience
                                                    <input type="radio" id="fresher" name="seeker" value="Fresher"  <?php if ($list['exp_fre'] == 'Fresher' ) echo 'checked' ; ?>>Fresher
                                                                    </div>
                                                                </div>
