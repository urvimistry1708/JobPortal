                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>Question Answer </div>
                                        <div class="tools"> </div>
                                    </div>
                                                 ...
                                                 foreach($data as $row)
                                                 {
                                                    ...
                                                    <td><?php echo $row['question_title'];?></td>
                                                     <td><?php echo $row['answer'];?></td>
                                                       <td><a href="<?php echo base_url();?>admin/questionanswerstable/getanswer?id=<?php echo $row['answer_id']?>"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp&nbsp<a><i class="fas fa-minus-circle" onclick="deletedata(<?php echo $row['answer_id']; ?>)" ></i></a></td>  
                                               <?php
                                                 }
