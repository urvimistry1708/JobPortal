                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    <form method="POST" class="horizontal-form">
                                                       ...
                                                       ?>
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">question answers Details</span>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        <input type="text" name="answer_id" id="answer_id" value="<?php echo $list['answer_id']; ?>"  hidden>
                                                                       <select class="form-control" id="questionss" name="questionss" tabindex="1">
                                            <option value="">Choose questions</option>
                                                                  
                                                                    <option value="<?php echo $list['question_id'] ;?>"><?php echo $list['question_title']; ?></option>
                                                              </select>
                                                         <span id="errque" class="text-danger"></span> 
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
                                                               <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="answers" name="answers" class="form-control" placeholder="" value="<?php echo $list['answer'];?>">
                                                                        <span class="text-danger" id="errans">  </span>
                                                                    </div>
                                                                 </div>
                                                            </div>
                                                            <!--/row--> 
...
<![endif]-->
     ...
     <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/question_answer.js?<?php echo rand(0,9999);?>"></script>
