                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    <form method="POST" class="horizontal-form">
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">services Details</span>
                                                ...
                                                <input type="text" name="service_id" id="service_id" value="<?php echo $list['service_id']; ?>" hidden>
                                                <input type="text" id="servicename" name="servicename" class="form-control" placeholder="Enter service name" value="<?php echo $list['service_name'] ;?>">
...
<![endif]-->
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery-3.3.1.min.js?<?php echo rand(0,9999);?>"></script>
         <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/services.js?<?php echo rand(0,9999);?>?<?php echo rand(0,9999);?>"></script>
