                ...
                <!-- BEGIN CONTENT -->
                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form class="horizontal-form"  name="jobrole" id="jobrole">
                                                        <?php
                                                            foreach($jrole_list  as $list)
                                                            {
                                                        ?>
                                                        <div class="form-body">
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">Job Role</span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="job_role_id" id="job_role_id" value="<?php echo $list['job_role_id'] ;?>" hidden>
                                                                        <input type="text" id="jobrolee" name="jobrolee" class="form-control" placeholder="Enter job role" value="<?php echo $list['job_role_title'] ;?>">
                                                  ...
                                                  <input type="button" value="Save" class="btn blue" onclick="updatedata()">
...
<![endif]-->
     ...
     <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jobrole.js?<?php echo rand(0,9999);?>"></script>
