                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                       ...
                                                                       <select class="form-control" id="questions" name="questions" tabindex="1">
                                            <option value="">Choose questions</option>
                                                                    <?php foreach($this->question_answers_model->question() as $tagData): ?>
                                                                    <option value="<?php echo $tagData->question_id ;?>"><?php echo $tagData->question_title; ?></option><?php endforeach; ?>
                                        </select>
                                        <span id="errque" class="text-danger"></span>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="answerid" name="answerid" class="form-control" placeholder="">
...
<![endif]-->
     ...
     <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/question_answer.js"></script>
