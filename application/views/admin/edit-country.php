                ...
                <!-- BEGIN CONTENT -->
                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form class="horizontal-form"  name="country" id="country">
                                                        <?php
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">Country</span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="country_id" id="country_id" value="<?php echo $list['country_id'] ;?>" hidden>
                                                                        <input type="text" id="country_namee" name="country_namee" class="form-control" placeholder="Enter job country name" value="<?php echo $list['country_name'] ;?>">
...
<![endif]-->
     ...
     <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/country.js?<?php echo rand(0,9999);?>"></script>
