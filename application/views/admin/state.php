                ...
                <!-- BEGIN CONTENT -->
                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form class="horizontal-form"  action="state/view" name="country" id="country">
                                                        <div class="form-body">
                                                            <h3 class="form-section"> <div class="form-body">
                                                            <div class="caption">
                                                        <i class="icon-equalizer font-red-sunglo"></i>
                                                        <span class="caption-subject font-red-sunglo bold uppercase">State</span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="state_namee" name="state_namee" class="form-control" placeholder="Enter state name">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="countryy" name="countryy">
                                                                           <option value="">Choose a country</option>
                                                                    <?php foreach($this->state_model->country() as $tagData): ?>
                                                                    <option value="<?php echo $tagData->country_id; ?>">
                                                                    <?php echo $tagData->country_name;?>    
