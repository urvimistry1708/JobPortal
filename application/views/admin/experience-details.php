                        ...
                        <h3> <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">         IS Current Job? <span style="color: red;">*</span></label><br>
                                    <input type="checkbox" name="iscurrentjob" id="iscurrentjob" value="1">  
                                    </div>
                                </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="state_id" name="state_id" onchange="getCity()">
                            ...
                            <div class="row">                         
                                <div class="col-md-6">
                                    ...
                                    <input type="date" id="jdate" name="jdate" class="form-control" placeholder="dd/mm/yyyy">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" id="rdate" name="rdate" class="form-control" placeholder="dd/mm/yyyy">
                            ...
                            <div class="form-actions left">
                                ...
                                <input type="button" class="btn blue" onclick="adddata()" class="fa fa-check" value="Save">
