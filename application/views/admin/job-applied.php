                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <form  id="job-applied" class="horizontal-form">
                                                 ...
                                                 <div class="col-md-6">
                                                    ...
                                                    <input type="text" id="interviewschedule" name="interviewschedule" class="form-control" placeholder="Enter interview schedule">
                                                    ...
                                                    <input type="date" id="entrydate" name="entrydate" class="form-control" placeholder="Enter entry date">
                                                    <span id="err_e" class="text-danger"></span>
                                                     ...
                                                     <div class="form-actions left">
                                                         <button type="button" onclick="adddata()" class="btn blue" id="seeker-submit" name="seeker-submit"> <i class="fa fa-check"></i> Save</button>
