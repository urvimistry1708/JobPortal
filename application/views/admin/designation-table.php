                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>Designation </div>
                                        <div class="tools"> </div>
                                    </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td><a href="<?php echo base_url();?>admin/designationtable/getDesi?id=<?php echo $row['designation_id']?>"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp&nbsp<a><i class="fas fa-minus-circle" onclick="deletedata(<?php echo $row['designation_id']; ?>)" ></i></a></td>
                                               </tr>
                                               <?php
                                           }
                                           ?>
...
<![endif]-->
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery-3.3.1.min.js?<?php echo rand(0,9999);?>"></script>
         <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/designation.js?<?php echo rand(0,9999);?>"></script>
