    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                ...
                <!-- BEGIN CONTENT -->
                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <div class="col-md-6">
                                    ...
                                    <option value="<?php echo $tagData->company_profile_id; ?>"><?php echo $tagData->company_name; ?></option><?php endforeach; ?>
                                    </select>
        ...
        <select class="form-control" id="rskill" name="rskill">
                        <option value="">Select Skill</option>
                            ...
                            <option value="<?php echo $tagData->require_skill_id; ?>"><?php echo $tagData->require_skill; ?></option><?php endforeach; ?>
                        </select>
                                                                    </div>
                                                                </div>
                        ...
                        <input type="text" id="min_qualification" name="min_qualification" class="form-control">
                             ...
                             <option value="Temporary">Temporary</option>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input typr="text" id="joblocation" name="joblocation" class="form-control">
                                                                    </div>
                                                                </div>
                                                           </div>
                                                           <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" id="lastapplydate" name="lastapplydate" class="form-control" placeholder="dd/mm/yyyy">
                                                           ...
                                                           <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" class="form-control" id="jobcloseddate" name="jobcloseddate" placeholder="dd/mm/yyyy">
                                                     ...
                                                     <div class="form-actions left">
                                                            ...
                                                            <button type="button" onclick="adddata()" class="btn blue">
