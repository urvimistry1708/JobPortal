                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="user_profile_id" name="user_profile_id" value="<?php echo $list['user_profile_id'] ;?>" hidden>
                                                                        <input type="text" id="companyname" name="companyname" class="form-control" placeholder="Enter company name" value="<?php echo $list['company_name'] ;?>">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        <select class="form-control" tabindex="1" id="joiningyear" name="joiningyear">
                                                                            <option><?php echo $list['joining_year'] ;?></option>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        <select class="form-control" tabindex="1" id="resignyear" name="resignyear" >
                                                                            <option><?php echo $list['resign_year'] ;?></option>
                                                                    ...
                                                                    <div class="form-group">
                                                                       <label class="control-label">Joining Month</label>
                                                                        <select class="form-control" tabindex="1" id="joiningmonth" name="joiningmonth">
                                                                            <option><?php echo $list['joining_month'] ;?></option>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        <select class="form-control" tabindex="1" id="resignmonth" name="resignmonth">
                                                                            <option ><?php echo $list['resign_month'] ;?></option>
                                                         ...
                                                         <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <option value="<?php echo $list['job_role_id']; ?>"><?php echo $list['job_role_title']; ?></option>
                                                                     <option value="">&nbsp&nbsp</option>
                                                                   
                                                                    <?php foreach($this->userprofle_model->jobrole() as $tagData): ?>
                                                                    <option value="<?php echo $tagData->job_role_id; ?>" selected>
                                                                    <?php echo $tagData->job_role_title;?>    
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <option value="<?php echo $list['designation_id'] ?>"><?php echo $list['designation']; ?></option>
                                                                     <option value="">&nbsp&nbsp</option>
                                                                     <?php foreach($this->userprofle_model->designation() as $Data): ?>
                                                                    <option value="<?php echo $Data->designation_id; ?>">
                                                             ...
                                                             <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" tabindex="1" id="currentsal" name="currentsal" value="<?php echo $list['current_salary'] ;?>">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        ...
                                                                        <select class="form-control" tabindex="1" id="experience" name="experience" value="<?php echo $list['experience'] ;?>">
                                                  ...
                                                  <input type="button" onclick="updatedata()" class="btn blue" value="Save">
