                ...
                <!-- BEGIN CONTENT -->
                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form class="horizontal-form"  name="specialization" id="specialization">
                                                        <?php
                                                        foreach($specialization_list as $list)
                                                        { 
                                                        ?>
                                                        <div class="form-body">
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">Specialization</span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="specialization_id" id="specialization_id" value="<?php echo 
                                                                        $list['specialization_id'] ;?>" hidden>
                                                                        <input type="text" id="specializationn" name="specializationn" class="form-control" placeholder="Enter specialization" value="<?php echo 
                                                                        $list['specialization'] ;?>">
...
<![endif]-->
     ...
     <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/specialization.js?<?php echo rand(0,9999);?>"></script>
