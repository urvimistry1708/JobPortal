                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>Job Title </div>
                                        <div class="tools"> </div>
                                    </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td><a href="<?php echo base_url();?>admin/jobtitletable/getJobtitle?id=<?php echo $row['job_title_id']?>"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp&nbsp<a><i class="fas fa-minus-circle" onclick="deletedata(<?php echo $row['job_title_id']; ?>)" ></i></a></td>
                                               </tr>
                                               <?php
                                           }
                                           ?>
