                ...
                <!-- BEGIN CONTENT -->
                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form class="horizontal-form"  name="jobtitle" id="jobtitle">
                                                        <?php
                                                            foreach($jobtitle_list as $list)
                                                            {
                                                        ?>
                                                        <div class="form-body">
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">Job Title</span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="job_title_id" id="job_title_id" value="<?php echo $list['job_title_id'] ;?>" hidden>
                                                                        <input type="text" id="jobtitlee" name="jobtitlee" class="form-control" placeholder="Enter job title" value="<?php echo $list['job_title'] ?>">
                                                                        <span id="errjobt" class="text-danger"></span>
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
...
<![endif]-->
     ...
     <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jobtitle.js?<?php echo rand(0,9999);?>"></script>
