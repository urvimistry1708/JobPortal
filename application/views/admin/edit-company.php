                    ...
                    <!-- BEGIN CONTENT BODY -->
                        ...
                        <!-- END PAGE BAR -->
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" name="company_profile_id" id="company_profile_id" value="<?php echo $list['company_profile_id'];  ?>" hidden>
                                                <input type="text" id="companyname" name="companyname" class="form-control" value="<?php echo $list['company_name'];  ?>">
                                                ...
                                                <input type="text" name="profiledescription" id="profiledescription" class="form-control" value="<?php echo $list['profile_description'];  ?>">
                        ...
                        <div class="row">
                             <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" placeholder="dd/mm/yyyy" id="establishdate" name="establishdate" value="<?php echo $list['establish_date'];?>" >
                                                ...
                                                <input type="email" name="email" id="email" class="form-control" placeholder="abc@gmail.com" value="<?php echo $list['email'];  ?>">
                                               ...
                                               <input type="checkbox" id="iso" name="iso" value="1"  <?php if ($list['ISO'] == '1' ) echo 'checked' ; ?>>    
                                                </div>
                                                                    </div>
                                                                </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Company Rating</label><br>
                                                                        <input type="radio"  name="rating" value="1" <?php if ($list['rating'] == '1' ) echo 'checked' ; ?>/>  1
                                                    <input type="radio"  name="rating" value="2"  <?php if ($list['rating'] == '2' ) echo 'checked' ; ?>>  2
                                                    <input type="radio"  name="rating" value="3"  <?php if ($list['rating'] == '3' ) echo 'checked' ; ?>>  3
                                                    <input type="radio"  name="rating" value="4"  <?php if ($list['rating'] == '4' ) echo 'checked' ; ?>>  4
                                                    <input type="radio"  name="rating" value="5"  <?php if ($list['rating'] == '5' ) echo 'checked' ; ?>>  5
                                                            ...
                                                            <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        name="contact"class="form-control" placeholder="Enter Company Contact" value="<?php echo $list['contact'];  ?>">
                                                ...
                                                <input type="text" name="company_website" id="company_website" class="form-control" value="<?php echo $list['company_website'];  ?>">
...
<![endif]-->
     ...
     <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/update_company_profile.js?<?php echo rand(0,9999);?>"></script>
