                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>User Profile </div>
                                        <div class="tools"> </div>
                                    </div>
                                            ...
                                            <tbody>
                                             <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['resign_year'];?></td>
                                                    <td><?php echo $row['joining_month'];?></td>
                                                    <td><?php echo $row['resign_month'];?></td>
                                                    <td><?php echo $row['job_role_title'];?></td>
                                                    <td><?php echo $row['designation'];?></td>
                                                    <td><?php echo $row['current_salary'];?></td>
                                                    <td><?php echo $row['experience'];?></td>
                                                     <td><a href="<?php echo base_url();?>admin/userprofiletable/getUserProfile?id=<?php echo $row['user_profile_id']?>"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp&nbsp
                                                        <a><i class="fas fa-minus-circle" onclick="deletedata(<?php echo $row['user_profile_id']; ?>)" ></i></a></td>
                                                </tr>
                                               <?php
                                           }
                                               ?>
