            ...
            <div class="page-container">
               ...
               <!-- END SIDEBAR -->
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form class="horizontal-form" id="experience-details">
                        <?php
                        ...
                        <h3> <div class="form-body">
                             ...
                             <span class="caption-subject font-red-sunglo bold uppercase">Experience Details</span>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                     ...
                                     <input type="text" name="experience_id" id="experience_id" value="<?php echo $list['experience_id'];?>" hidden>
                                     <select class="form-control" id="jobtitlee" name="jobtitlee">
                                        <option value="<?php echo $list['job_title_id'] ; ?>"><?php echo $list['job_title']; ?></option>
                                        <option value="">Choose job title</option>
                                        <?php foreach($this->experience_model->jobtitle() as $tagData):?>
                                        <option value="<?php echo $tagData->job_title_id; ?>"><?php echo $tagData->job_title; ?></option>
                                    <?php endforeach;?>
                                    
                                     </select>
                                     <span id="errjt" class="text-danger"></span>
                                </div>
                                </div>
                                                                <!--/span-->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="companyname" name="companyname">
                                        <option><?php echo $list['company_name']; ?></option>
                                    <option value="">Choose company name</option>
                                    <option value="TCS">TCS</option>
                                    <option value="Infosis">Infosis</option>
                                    <option value="Dominant">Dominant</option>
                                    <option value="BCube Solution">BCube Solution</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="country_id" name="country_id" onchange="getStatee(<?php echo $list['state_id']; ?>)">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="state_id" name="state_id" onchange="getCityy(<?php echo $list['city_id']; ?>)">
                            ...
                            <div class="row">                         
                                <div class="col-md-6">
                                    ...
                                    <input type="date" id="jdate" name="jdate" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $list['start_date']; ?>">
                                    <span id="errjdate" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="control-label">Resign Date <span style="color: red;">*</span></label>
                                    <input type="date" id="rdate" name="rdate" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $list['end_date']; ?>">
                                    <span id="errrdate" class="text-danger"></span>
                                    </div>
                                </div>
                                                                <!--/span-->
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="descriptionn" name="descriptionn" class="form-control" value="<?php echo $list['description']; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--/row-->
                        ...
                        ?>
                            <div class="form-actions left">
                                ...
                                <input type="button" class="btn blue" onclick="updatedata()" class="fa fa-check" value="Update">
...
<![endif]-->
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/experience-details.js?<?php echo rand(0,9999);?>">
