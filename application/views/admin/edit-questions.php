                        ...
                        <!-- END PAGE BAR -->
                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    ?>
                                                        ...
                                                        <span class="caption-subject font-red-sunglo bold uppercase">questions Details</span>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div >
                                                                        <label class="control-label">Question Title</label>
                                                                         <input type="text" name="question_id" id="question_id" value="<?php echo $list['question_id']; ?>" hidden>
                                                                        <input type="text" id="questiontitlee" name="questiontitlee" class="form-control" placeholder="Enter question title"  value="<?php echo $list['question_title'];  ?>">
